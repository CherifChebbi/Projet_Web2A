...
session_start();
	...
	//$list2 = $PublicationC->listPublication2();
	
	$CommentaireC = new CommentaireC();
	$list_com = $CommentaireC->listCommentaire2();	
...
<nav aria-label="Page navigation" style="ext-align: end !important;">
			<ul class="pagination justify-content-end" style="padding-left: 770px;">
				<?php if ($page_num > 1) : ?>
					<li class="page-item">
						<a class="page-link" href="?page=<?= $page_num - 1 ?>" aria-label="Précédent">
				...
				<?php if ($page_num < $total_pages) : ?>
					<li class="page-item">
						<a class="page-link" href="?page=<?= $page_num + 1 ?>" aria-label="Suivant">
