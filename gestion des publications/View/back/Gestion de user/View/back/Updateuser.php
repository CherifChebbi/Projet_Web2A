...
if (
    ...
    if (
        ...
        $userP->updateUser($user, $_POST['Iduser']);
...
<div class="container-xxl position-relative bg-white d-flex p-0">
    ...
    if (isset($_POST['Iduser'])) {
        $user = $userP->showUser($_POST['Iduser']);
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="mb-3">
                                    ...
                                    <input type="text" name="Iduser" class="form-control" id="Iduser" value="<?php echo $user['Iduser']; ?>">
                                </div> 
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="Age" class="form-control" id="Age"value="<?php echo $user['Age'];?>">
                                </div> 
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control"  id="Semail" name="Semail" value="<?php echo $user['Semail']; ?>"
                                        aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Password</label>
                                    <input type="password" class="form-control" name="Spassword" id="Spassword" value="<?php echo $user['Spassword']; ?>" >
                                </div>
                                <div class="mb-3">
