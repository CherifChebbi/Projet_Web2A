...
// Check if Iduser parameter is passed through GET
if (isset($_GET['Iduser'])) {
    $UserP= new UserP();
    $user = $UserP->showUser($_GET['Iduser']);
} else {
    // If Iduser parameter is not passed, redirect to listusers.php
...
<div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="row w-100 mx-0 mt-3">
            <div class="col-12">
                <table border="1" align="center" width="70%" class="table text-start align-middle table-bordered table-hover mb-0">
                    <tr>
                        <th>Id user</th>
                        <td><?= $user['Iduser']; ?></td>
                    </tr>
        ...
        <div class="btn-group" role="group">
                    ...
                    <form method="POST" action="updateuser.php">
                        <input type="submit" name="update" class="btn btn-outline-secondary m-2"  value="Update" target="_self">
                    ...
                    <a href="deleteuser.php?Iduser=<?php echo $user['Iduser']; ?>" class="btn btn-outline-danger m-2" >Delete</a> 
                    <a href="generatePDF.php?Iduser=<?php echo $_GET['Iduser']; ?>"class="btn btn-outline-info m-2">Generate PDF</a>
